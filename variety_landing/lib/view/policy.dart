...
Last Updated: July 4, 2024
   ...
   These Terms of Service (this “Agreement”) is between you and Variety Dating, LLC. (“Variety Dating” “we,” “us,” or “our”). By using our mobile application available on Android and iOS devices (each, our “App”), and/or other services we provide (collectively, the “Services”) you agree to be bound by this Agreement. If you do not agree to be bound by this Agreement, you may not use the Services. Your use of, or participation in, certain Services may be subject to additional terms which will be presented to you when you access those Services.
...
• 
         Creating an Account on Variety. In order to use Variety, you must create an account with us (an “Account”) by first logging in with your Facebook account or by providing your email address. If you choose to create an Account by logging in with Facebook, you authorize us to access and use certain Facebook account information, including but not limited to your public Facebook profile photographs, personal information, and Facebook friends (to display common friends with other Users). For more information regarding the information we collect from you and how we use it, please consult our Privacy Policy.
            
• 
         Your Account is only for you. You may only access and use your Account in accordance with this Agreement and for your personal use to find and communicate with potential dating partners. You may not authorize others to access or use your Account, and you may not assign or otherwise transfer your Account to any other person or entity. You acknowledge that we are not responsible from any third party access to your Account, particularly any such access that results from theft or misappropriation of your Account or Facebook account’s login credentials. You agree to immediately notify Variety of any disclosure or unauthorized use of your login credentials at support@varietydating.net.
...
• 
         Use, display, mirror or frame the Services or any individual element within the Services, our name, any Variety trademark, logo or other proprietary information, or the layout and design of any page or form contained on a page, without our express written consent;
...
• 
         Rights in App Granted by Variety. Subject to your compliance with this Agreement, Variety grants to you a limited non-exclusive, non-transferable license, with no right to sublicense, to download and install a copy of the App on a mobile device or computer that you own or control and to run such copy of the App solely for your own personal non-commercial purposes. You may not copy the App, except for making a reasonable number of copies for backup or archival purposes. Except as expressly permitted in this Agreement, you may not: (i) copy, modify or create derivative works based on the App; (ii) distribute, transfer, sublicense, lease, lend or rent the App to any third party; (iii) reverse engineer, decompile or disassemble the App; or (iv) make the functionality of the App available to multiple users through any means. Variety reserves all rights in and to the App not expressly granted to you under this Agreement.
...
• 
               This Agreement is concluded between you and Variety, and not with the App Provider, and Variety (not the App Provider), is solely responsible for the App.
...
• 
               In the event of any third party claim that the App or your possession and use of that App infringes that third party’s intellectual property rights, Variety will be solely responsible for the investigation, defense, settlement and discharge of any such intellectual property infringement claim to the extent required by this Agreement.
...
• 
   ...
   11. No GuaranteesYou understand that Variety does not guarantee you any matches, does not guarantee any number or frequency of matches, or the accuracy, availability, or other attributes of any User. You understand that Variety makes no guarantees about the Services, either explicit or implied, including your compatibility with any other User.
   
   12. Reporting of Violations; General Contact Info.
   If you discover any violation of the Agreement by others, please report it to us at support@varietydating.net. You may also use this address to contact us with any questions you may have about the Services.
...
• 
         NEITHER Variety NOR ANY OTHER PARTY INVOLVED IN CREATING, PRODUCING, OR DELIVERING THE SERVICES WILL BE LIABLE FOR ANY INCIDENTAL, SPECIAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES, OR DAMAGES FOR LOST PROFITS, LOST REVENUES, LOST SAVINGS, LOST BUSINESS OPPORTUNITY, LOSS OF DATA OR GOODWILL, SERVICE INTERRUPTION, COMPUTER DAMAGE OR SYSTEM FAILURE OR THE COST OF SUBSTITUTE SERVICES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT OR FROM THE USE OF OR INABILITY TO USE THE SERVICES, WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), PRODUCT LIABILITY OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT Variety OR ANY OTHER PARTY HAS BEEN INFORMED OF THE POSSIBILITY OF SUCH DAMAGE, EVEN IF A LIMITED REMEDY SET FORTH HEREIN IS FOUND TO HAVE FAILED OF ITS ESSENTIAL PURPOSE. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF LIABILITY FOR CONSEQUENTIAL OR INCIDENTAL DAMAGES, SO THE ABOVE LIMITATION MAY NOT APPLY TO YOU.
            
• 
         IN NO EVENT WILL Variety’S TOTAL LIABILITY ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT OR FROM THE USE OF OR INABILITY TO USE THE SERVICES EXCEED THE AMOUNTS YOU HAVE PAID TO Variety FOR USE OF THE SERVICES OR FIFTY DOLLARS (\$50), IF YOU HAVE NOT HAD ANY PAYMENT OBLIGATIONS TO Variety, AS APPLICABLE.
            
• 
         THE EXCLUSIONS AND LIMITATIONS OF DAMAGES SET FORTH ABOVE ARE FUNDAMENTAL ELEMENTS OF THE BASIS OF THE BARGAIN BETWEEN Variety AND YOU.
         
   
   16. Indemnification
   You will indemnify and hold harmless Variety and its officers, directors, employees and agents, from and against any claims, disputes, demands, liabilities, damages, losses, and costs and expenses, including, without limitation, reasonable legal and accounting fees arising out of or in any way connected with (i) your access to or use of the Services, (ii) your User Content, or (iii) your violation of this Agreement.
   
   17. Termination
   We may terminate your access to and use of the Services, at our sole discretion, at any time and without notice to you. You may delete your Account, or put your Account on hold at any time by sending an email to us at support@varietydating.net or via the functionality of the App; deleting your Account is your sole method of terminating this Agreement. Upon termination of this Agreement, the following will survive Sections 3(d),6(c),7,14,15,16,18,19,21, and this sentence of Section 17.
   
   18. Governing Law and Forum Choice
   This Agreement and any action related thereto will be governed by the Federal Arbitration Act, federal arbitration law, and the laws of the State of California, without regard to its conflict of laws provisions. Except as otherwise expressly set forth in Section 19“Dispute Resolution,” the exclusive jurisdiction for all Disputes (defined below) that you and Variety are not required to arbitrate will be the state and federal courts located in the Northern District of California, and you and Variety each waive any objection to jurisdiction and venue in such courts.
   
   19. Dispute Resolution
   
      
• 
         Mandatory Arbitration of Disputes.We each agree that any dispute, claim or controversy arising out of or relating to this Agreement or the breach, termination, enforcement, interpretation or validity thereof or the use of the Services (collectively, “Disputes”) will be resolved solely by binding, individual arbitration and not in a class, representative or consolidated action or proceeding. You and Variety agree that the U.S. Federal Arbitration Act governs the interpretation and enforcement of this Agreement, and that you and Variety are each waiving the right to a trial by jury or to participate in a class action. This arbitration provision shall survive termination of this Agreement.
            
• 
         Exceptions and Opt-out. As limited exceptions to Section 19(a)above: (i) you may seek to resolve a Dispute in small claims court if it qualifies; and (ii) we each retain the right to seek injunctive or other equitable relief from a court to prevent (or enjoin) the infringement or misappropriation of our intellectual property rights. In addition, you will retain the right to opt out of arbitration entirely and litigate any Dispute if you provide us with written notice of your desire to do so by email at support@varietydating.net within thirty (30) days following the date you first agree to this Agreement.
...
• 
         Class Action Waiver.  YOU AND Variety AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE PROCEEDING. Further, if the parties’ dispute is resolved through arbitration, the arbitrator may not consolidate another person’s claims with your claims, and may not otherwise preside over any form of a representative or class proceeding.  If this specific provision is found to be unenforceable, then the entirety of this Dispute Resolution section shall be null and void.
            
• 
         Effect of Changes on Arbitration.Notwithstanding the provisions of Section 4“Changes to Agreement or Services” above, if Variety changes any of the terms of this Section 19“Dispute Resolution” after the date you first accepted this Agreement (or accepted any subsequent changes to this Agreement), you may reject any such change by sending us written notice (including by email to support@varietydating.net) within 30 days of the date such change became effective, as indicated in the “Last Updated” date above or in the date of Variety’s email to you notifying you of such change. By rejecting any change, you are agreeing that you will arbitrate any Dispute between you and Variety in accordance with the terms of this Section 19“Dispute Resolution” as of the date you first accepted this Agreement (or accepted any subsequent changes to this Agreement).
...
• 
   ...
   Variety Attn: Cancellations 382 NE 191st St #867422 Miami FL 33179 (in addition, California and Ohio users may email us at support@varietydating.net).
   
   Please include your Variety email address in any correspondence or your refund may be delayed. If you cancel, Variety will return, within ten days of the date on which you give notice of cancellation, any payments you have made. If you send or deliver the notice to cancel your subscription agreement within such three day period, we will refund the full amount of your subscription.In the event that you die before the end of your subscription period, your estate shall be entitled to a refund of that portion of any payment you had made for your subscription which is allocable to the period after your death. In the event that you become disabled (such that you are unable to use the Services) before the end of your subscription period, you shall be entitled to a refund of that portion of any payment you had made for your subscription which is allocable to the period after your disability by providing the company notice at the same address as listed above.California UsersCalifornia Civil Code Section 1789.3 requires us to provide you with the following information: You may file grievances and complaints with the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs, 400 R Street, Suite 1080, Sacramento, California, 95814, or by telephone at (916) 445-1254 or (800) 952-5210, or by email at dca@dca.ca.gov.
   
   21. General Terms
   
      
• 
         Entire Agreement. This Agreement constitute the entire and exclusive understanding and agreement between Variety and you regarding the Services and Content, and this Agreement supersede and replace any and all prior oral or written understandings or agreements between Variety and you regarding the Services and Content. If any provision of this Agreement is held invalid or unenforceable by an arbitrator or a court of competent jurisdiction, that provision will be enforced to the maximum extent permissible and the other provisions of this Agreement will remain in full force and effect. You may not assign or transfer this Agreement, by operation of law or otherwise, without Variety’s prior written consent. Any attempt by you to assign or transfer this Agreement, without such consent, will be null. Variety may freely assign or transfer this Agreement without restriction. Subject to the foregoing, this Agreement will bind and inure to the benefit of the parties, their successors and permitted assigns.
            
• 
         Notices. Any notices or other communications provided by Variety under this Agreement, including those regarding modifications to this Agreement, will be given: (i) via email; or (ii) by posting to the Services. For notices made by e-mail, the date of receipt will be deemed the date on which such notice is transmitted.
            
• 
         Waiver of Rights. Variety’s failure to enforce any right or provision of this Agreement will not be considered a waiver of such right or provision. The waiver of any such right or provision will be effective only if in writing and signed by a duly authorized representative of Variety. Except as expressly set forth in this Agreement, the exercise by either party of any of its remedies under this Agreement will be without prejudice to its other remedies under this Agreement or otherwise.
...
• 
    ...
    var richTextView = SingleChildScrollView(
        child: Text.rich(
      TextSpan(
        children: [TextSpan(text: richText)],
      ),
    ));
